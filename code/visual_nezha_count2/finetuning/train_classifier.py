...
class Config:
    def __init__(self):
        ...
        self.pretrained_bert_path = os.path.join(abs_path,'../../../data/pretrain_model/pretrained_nezha/')
...
if __name__=='__main__':
    ...
    save_model_path = '../../../data/model_data/visual_nezha_count2/'
    ...
    for e in range(config.epoch):
        ...
        for input_ids, input_masks, segment_ids, targets in tq:
            ...
            loss = 6*loss_fn(y_pred[12].view(-1,2), label_t[:,12])
            for i in range(12):
