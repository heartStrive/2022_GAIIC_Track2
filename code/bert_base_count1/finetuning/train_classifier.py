...
if __name__=='__main__':
    ...
    from process_data import generate_train_test_data_for_bert_base_count1

    MODEL_CLASSES = {
        'BertConcat': BertConcat, # fuselayer
    }
    ...
    save_model_path = '../../../data/model_data/bert_base_count1/'
